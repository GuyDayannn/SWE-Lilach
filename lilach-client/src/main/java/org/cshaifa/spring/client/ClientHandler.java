...
public class ClientHandler {
    ...
    public static CreateItemResponse createItem(String name, double price, Map<Store, Integer> quantities, boolean onSale, double discountPercent, String size, String itemType, String itemColor, boolean isDefault, byte[] image) throws IOException {
        CreateItemRequest createItemRequest = new CreateItemRequest(name, price, quantities, onSale, discountPercent, size, itemType, itemColor, isDefault, image);
        client.openConnection();
