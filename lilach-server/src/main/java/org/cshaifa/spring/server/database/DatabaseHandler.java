...
public class DatabaseHandler {
    ...
    public static void initializeDatabaseIfEmpty() throws Exception {
            ...
            if (imageList!=null) {
                for (Path imagePath : imageList) {
                    ...
                    randomItems.add(new CatalogItem(
                            ...
                            sizes[randomInt], itemTypes[typeInd], colors[randomInt], true));
                }
            }
            typeInd++;
        }
        ...
        randomItems.add(0,new CatalogItem("Sale flower", imageLists.get(0).get(0).toUri().toString(), 249.99, 10, true, 50.0, "large", "flower", "white", true));
        randomItems.remove(1);
        randomItems.add(1,new CatalogItem("Sale flower", imageLists.get(0).get(1).toUri().toString(), 149.99, 10, true, 50.0, "medium", "flower", "yellow", true));
